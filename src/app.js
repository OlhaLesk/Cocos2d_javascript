    ...
    ctor:function ()
    {
        ...
        for (i = 0; i < 3; i++)
        {
            for (j = 0; j < 5; j++)
            {
                ...
                var spriteWidth = backgroundSprite.getContentSize().width;
                var spriteHeight = backgroundSprite.getContentSize().height;
                var x = size.width - j * spriteWidth - (size.width - spriteWidth * 4) / 2;
                var y = size.height - i * spriteHeight - (size.height - spriteHeight * 3);
